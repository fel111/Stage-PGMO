...
struct param{
	...
	int aff_log_ordo_cplex = 0; // 1 si on souhaite afficher le deroulement cplex ordo
	...
	int aff_log_compact_cplex = 0; // 1 si on souhaite afficher le deroulement cplex du modele compact
